...
namespace TightWiki.Web.Engine
{
    public class TightEngine : ITightEngine
    {
        ...
        public ITightEngineState Transform(IEngineConfiguration config, IEngineDataProvider dataProvider, ISessionState? session, IPage page, int? revision = null, WikiMatchType[]? omitMatches = null)
            => new TightEngineState(this, config, dataProvider, session, page, revision, omitMatches).Transform();
    }
}
