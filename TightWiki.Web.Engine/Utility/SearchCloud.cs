...
namespace TightWiki.Web.Engine.Utility
{
    ...
    {
        public static string Build(string basePath, IEngineDataProvider dataProvider, List<string> searchTokens, int? maxCount = null)
        {
            var pages = dataProvider.SearchPages(searchTokens).OrderByDescending(o => o.Score).ToList();
