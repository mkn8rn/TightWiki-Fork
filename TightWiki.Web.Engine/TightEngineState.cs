...
using TightWiki.Web.Engine.Function.Exceptions;
...
namespace TightWiki.Web.Engine
{
    public class TightEngineState : ITightEngineState
    {
        ...
        /// <summary>
        /// Configuration data needed by the Engine during transformation.
        /// This replaces direct access to GlobalConfiguration.
        /// </summary>
        public IEngineConfiguration Config { get; }

        /// <summary>
        /// Data provider for accessing pages, users, files, and configuration.
        /// This replaces direct access to static repositories.
        /// </summary>
        public IEngineDataProvider DataProvider { get; }
        ...
        internal TightEngineState(ITightEngine engine, IEngineConfiguration config, IEngineDataProvider dataProvider,
            ISessionState? session, IPage page, int? revision = null, WikiMatchType[]? omitMatches = null, int nestDepth = 0)
        {
        ...
        {
            return new TightEngineState(Engine, Config, DataProvider, Session, page, revision, OmitMatches.ToArray(), NestDepth + 1).Transform();
        }
        ...
        /// <summary>
        /// Matching nested blocks with regex was hell, I escaped with a loop. ¯\_(?)_/¯
        /// </summary>
        ...
        {
            _queryTokenHash = TightWiki.Utils.Security.Helpers.Sha256(TightWiki.Utils.Security.Helpers.EncryptString(TightWiki.Utils.Security.Helpers.MachineKey, _queryTokenHash));
            return $"H{TightWiki.Utils.Security.Helpers.Crc32(_queryTokenHash)}";
        }
