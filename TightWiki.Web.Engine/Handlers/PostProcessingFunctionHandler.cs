                ...
                case "tags": //##tags
                    {
                        ...
                        if (styleName == "list")
                        {
                            ...
                            {
                                html.Append($"<li><a href=\"{state.Config.BasePath}/Tag/Browse/{tag}\">{tag}</a>");
                            }
                            html.Append("</ul>");
                        }
                        else if (styleName == "flat")
                        {
                            foreach (var tag in state.Tags)
                            {
                                ...
                                html.Append($"<a href=\"{state.Config.BasePath}/Tag/Browse/{tag}\">{tag}</a>");
                            }
                        }
                ...
                case "tagcloud":
                    {
                        ...
                        string html = TagCloud.Build(state.Config.BasePath, state.DataProvider, seedTag, top);
                ...
                case "searchcloud":
                    {
                        ...
                        string html = SearchCloud.Build(state.Config.BasePath, state.DataProvider, tokens, top);
                        return new HandlerResult(html);
                    }
