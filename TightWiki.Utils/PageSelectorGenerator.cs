    ...
    public static class PageSelectorGenerator
    {
        public static IStringLocalizer Localizer
        {
            get
            {
                if (_localizer == null)
                {
                    throw new InvalidOperationException("PageSelectorGenerator has not been initialized. Call Initialize() with a valid IStringLocalizer instance.");
                }
                return _localizer;
            }
        }
