    ...
    public class LoginModel : PageModelBase
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                _exceptionService.LogException(ex, "LDAP authentication error");
            }
        }
                    ...
                    else
                    {
                        ...
                        if (GlobalConfiguration.EnableLDAPAuthentication)
                        {
                                ...
                                Input.Username, Input.Password, out var samAccountName, out var objectGuid))
                            {
                                ...
                                if (foundUser != null && _usersService.TryGetBasicProfileByUserId(Guid.Parse(foundUser.Id), out _))
                                {
                                ...
                                else
                                {
                                    ...
                                    if (_usersService.TryGetBasicProfileByUserId(Guid.Parse(foundUser.Id), out _) == false)
                                    {
                                        if (GlobalConfiguration.AllowSignup != true)
                                        {
                                            return Redirect($"{GlobalConfiguration.BasePath}/Identity/Account/RegistrationIsNotAllowed");
