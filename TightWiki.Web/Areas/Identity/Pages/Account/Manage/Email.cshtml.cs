    ...
    public class EmailModel : PageModelBase
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                var emailTemplate = new StringBuilder(_configurationService.GetConfigurationValue<string>(ConfigurationGroup.Membership, "Template: Account Verification Email"));
                var basicConfig = _configurationService.GetConfigurationEntriesByGroupName(ConfigurationGroup.Basic);
