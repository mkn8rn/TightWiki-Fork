...
{
    [Route("File")]
    public class FileController : WikiControllerBase<FileController>
    {
        ...
        public ActionResult Image(string givenPageNavigation, string givenFileNavigation, int? fileRevision = null)
        {
            ...
            var file = _pageFileService.GetPageFileAttachmentByPageNavigationFileRevisionAndFileNavigation(pageNavigation.Canonical, fileNavigation.Canonical, fileRevision);
            if (file != null)
            {
        ...
        public ActionResult Revisions(string givenPageNavigation, string givenFileNavigation)
        {
            ...
            var model = new PageFileRevisionsViewModel()
            {
                ...
                Revisions = _pageFileService.GetPageFileAttachmentRevisionsByPageAndFileNavigationPaged
        ...
        public ActionResult PageAttachments(string givenPageNavigation)
        {
            ...
            var page = _pageService.GetPageRevisionByNavigation(pageNavigation);
            if (page != null)
            {
                var pageFiles = _pageFileService.GetPageFilesInfoByPageId(page.Id);
        ...
        public IActionResult UploadDragDrop(string givenPageNavigation, List<IFormFile> postedFiles)
        {
            ...
            try
            {
                ...
                var page = _pageService.GetPageInfoByNavigation(pageNavigation.Canonical).EnsureNotNull();
                ...
                foreach (IFormFile file in postedFiles)
                {
                    if (file != null)
                    {
                        ...
                        if (fileSize > 0)
                        {
                            ...
                            {
                                Data = WebUtility.ConvertHttpFileToBytes(file),
            ...
            {
                _exceptionService.LogException(ex, "Failed to upload file.");
        ...
        public IActionResult ManualUpload(string givenPageNavigation, IFormFile fileData)
        {
            ...
            if (fileData != null)
            {
                ...
                if (fileSize > 0)
                {
                    ...
                    _pageFileService.UpsertPageFile(new PageFileAttachment()
                    {
                        Data = WebUtility.ConvertHttpFileToBytes(fileData),
                        CreatedDate = DateTime.UtcNow,
                        PageId = page.Id,
                        Name = fileName,
                        FileNavigation = Navigation.Clean(fileName),
        ...
        public ActionResult Detach(string givenPageNavigation, string givenFileNavigation, int pageRevision)
        {
            ...
            _pageFileService.DetachPageRevisionAttachment(
        ...
        {
            var emojis = _emojiService.AutoCompleteEmoji(q ?? string.Empty).ToList();
            ...
            if (string.IsNullOrEmpty(emojiNavigation) == false)
            {
                ...
                if (emoji != null)
                {
                    ...
                    if (emoji.ImageData == null)
                    {
                        ...
                        emoji.ImageData = _emojiService.GetEmojiByName(emoji.Name)?.ImageData;
